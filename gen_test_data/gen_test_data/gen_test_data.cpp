// gen_test_data.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void loopThroughFileGen(int iterations ) {
    ...
    for (int i = 5; i < iterations + 1; i++) {
        for (int j = 0; n_length - 1; j++) {
